...
rnaDir='bioprojects/stylophora_pistillata_PRJNA386774/rna_results/'
...
ttable=read.table('bioprojects/stylophora_pistillata_PRJNA386774/rna_treat_table.txt',
                  sep='\t',
                  header=TRUE, stringsAsFactors=FALSE)
counts = counts[,ttable$run]
coldata=ttable
remove(ttable)
coldata
...
#plot pca
NTOP=nrow(counts)
plot_RNA_PCA(rld.df, coldata, intgroup = 'treat', ntop=NTOP)
