...
rnaDir='bioprojects/primates/human/rna_results/'
...
sra = read_excel('metadata/Blake_SraRunTable.xlsx') %>% 
  ...
  mutate(Individual = paste("human", Individual, sep=''),
...
write_tsv(coldata, path='bioprojects/primates/human/rna_results/rna_treat_table.txt')
