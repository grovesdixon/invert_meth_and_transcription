...
rnaDir='bioprojects/primates/macaque/rna_results/'
...
sra = read_excel('metadata/Blake_SraRunTable.xlsx') %>% 
  ...
  mutate(Individual = paste("macac", Individual, sep=''),
...
write_tsv(coldata, path='bioprojects/primates/macaque/rna_results/rna_treat_table.txt')
